...
pub struct NetworkConfig {
    ...
    pub incoming: IncomingFileConfig,
...
impl MirrordToggleableConfig for NetworkFileConfig {
    fn disabled_config() -> Result<Self::Generated, ConfigError> {
        let incoming = FromEnv::new("MIRRORD_AGENT_TCP_STEAL_TRAFFIC")
            .source_value()
            .transpose()?
            .unwrap_or(IncomingFileConfig::Mirror);
...
mod tests {
    ...
    #[rstest]
    fn default(
        #[values((None, IncomingFileConfig::Mirror), (Some("false"), IncomingFileConfig::Mirror), (Some("true"), IncomingFileConfig::Steal(crate::incoming::steal::StealModeConfig::default())))]
        incoming: (Option<&str>, IncomingFileConfig),
